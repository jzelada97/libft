...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/05/26 12:17:00 by jzelada-          #+#    #+#              #
#    Updated: 2026/07/12 23:30:00 by jzelada-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= src/ft_atoi.c src/ft_bzero.c src/ft_calloc.c src/ft_isalnum.c \
			  ...
			  src/ft_lstiter.c src/ft_lstlast.c src/ft_lstmap.c \
			  src/ft_lstnew.c src/ft_lstsize.c src/ft_memchr.c \
			  src/ft_memcmp.c src/ft_memcpy.c src/ft_memmove.c \
			  src/ft_memset.c src/ft_putchar_fd.c src/ft_putendl_fd.c \
